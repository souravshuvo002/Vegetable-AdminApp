...
public class AddBannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add new banner");
    ...
    private void uploadBanner() {
         ...
         *
         */
        final android.app.AlertDialog waitingDialog = new SpotsDialog(AddBannerActivity.this);
        waitingDialog.show();
        ...
        //defining the call
        Call<Result> call = service.addBanner(name, body);
    ...
    private void selectImageFromGallery() {
        CheckPermission checkPermission = new CheckPermission(AddBannerActivity.this);
