...
public class AddFoodsActivity extends AppCompatActivity {
    ...
    private void loadUnitData() {
        ...
        call.enqueue(new Callback<Result>() {
            ...
            public void onResponse(Call<Result> call, Response<Result> response) {
                ...
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AddFoodsActivity.this, android.R.layout.simple_spinner_item, NameID);
    ...
    private void uploadFoods() {
        ...
        RequestBody date_added = RequestBody.create(MediaType.parse("text/plain"), Common.getDateTime());
         ...
         *
         */
        final android.app.AlertDialog waitingDialog = new SpotsDialog(AddFoodsActivity.this);
        waitingDialog.show();
        ...
        //defining the call
        Call<Result> call = service.addFoodItem(name, price, disPrice, desc, minUnitAmount, unit, id_menu, date_added, body);
    ...
    private void selectImageFromGallery() {
        CheckPermission checkPermission = new CheckPermission(AddFoodsActivity.this);
