...
public class AddMenuActivity extends AppCompatActivity {
    ...
    private void uploadMenu() {
         ...
         *
         */
        final android.app.AlertDialog waitingDialog = new SpotsDialog(AddMenuActivity.this);
        waitingDialog.show();
        ...
        //defining the call
        Call<Result> call = service.addMenu(name, body);
    ...
    private void selectImageFromGallery() {
        CheckPermission checkPermission = new CheckPermission(AddMenuActivity.this);
