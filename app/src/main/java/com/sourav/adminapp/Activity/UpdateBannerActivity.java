...
public class UpdateBannerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Update Banner");

        ID_BANNER = getIntent().getStringExtra("ID");
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(editTextName.getText().toString())) {
                    Toast.makeText(getApplicationContext(), "Banner name fields is empty", Toast.LENGTH_LONG).show();
    ...
    private void uploadBanner() {
        ...
        RequestBody ID = RequestBody.create(MediaType.parse("text/plain"), ID_BANNER);
         ...
         *
         */
        final android.app.AlertDialog waitingDialog = new SpotsDialog(UpdateBannerActivity.this);
        waitingDialog.show();
        ...
        //defining the call
        Call<Result> call = service.updateBanner(ID, name, body);
    ...
    private void selectImageFromGallery() {
        CheckPermission checkPermission = new CheckPermission(UpdateBannerActivity.this);
