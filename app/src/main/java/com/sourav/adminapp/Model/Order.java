...
public class Order {
    private String id, id_food, id_user, id_shipper, id_order, username, phone, email, address, area, comment, reason, total_price, order_date, order_status, food_delivery_date;
    ...
    private String amount, transfer_date;
    private String total_sale_amount, total_completed_order, total_cancelled_order, total_month_sale_amount,
            total_month_completed_order, total_month_cancelled_order;

    private String food_id, name, description, price, discount_price, image_url, min_unit_amount, unit, status, date_added;
    private String payment_method, payment_state, transfer_state;
    ...
    public String getTotal_completed_order() {
        return total_completed_order;
    }

    public void setTotal_completed_order(String total_completed_order) {
        this.total_completed_order = total_completed_order;
    }

    public String getTotal_cancelled_order() {
        return total_cancelled_order;
    }

    public void setTotal_cancelled_order(String total_cancelled_order) {
        this.total_cancelled_order = total_cancelled_order;
    }

    public String getTotal_month_sale_amount() {
        return total_month_sale_amount;
    }

    public void setTotal_month_sale_amount(String total_month_sale_amount) {
        this.total_month_sale_amount = total_month_sale_amount;
    }
    ...
    public String getTotal_month_completed_order() {
        return total_month_completed_order;
    }

    public void setTotal_month_completed_order(String total_month_completed_order) {
        this.total_month_completed_order = total_month_completed_order;
    }

    public String getTotal_month_cancelled_order() {
        return total_month_cancelled_order;
    }

    public void setTotal_month_cancelled_order(String total_month_cancelled_order) {
        this.total_month_cancelled_order = total_month_cancelled_order;
    }
}
